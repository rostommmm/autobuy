...
public class IngameGui extends AbstractGui
{
    ...
    {
        final EventRenderOverlay eventRenderOverlay = new EventRenderOverlay(matrixStack);
        Constants.EVENT_BUS.post(eventRenderOverlay);
    ...
    {
        final EventActionBar actionBar = new EventActionBar(component.getString());
        Constants.EVENT_BUS.post(actionBar);
